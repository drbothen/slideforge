...
|----|------|--------|----------|----------------|
| WAVE5-UNCERTAINTY-PASS | Wave-5 remove-uncertainty pass (Stages 2-4 pending). Stage 1 DONE (2026-06-07): ADR-021/022 authored, NFR-002 deferred (nfr-catalog v1.3, prd v1.1, BC-3.06.002 v1.3), export-arch v1.2, dep-graph v1.1. Residual: NFR-002 sibling-sweep needed for system-overview.md, cicd-setup.md, ux-spec files (FLOW-003/SCR-002/SCR-008/UX-INDEX). Stages 2-4 = story-spec propagation (21 stories updated with validated versions/APIs). MUST complete before Wave-5 delivery begins. | in_progress | P0 | vsdd-factory:remove-uncertainty output |
