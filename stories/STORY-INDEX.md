...
| Wave 5 | 34 | 23 | 0 | 4 | 7 | 0 |
| Wave 6 | 6 | 6 | 0 | 0 | 0 | 0 |
| Wave TBD | 1 | 1 | 0 | 0 | 0 | 0 |
| **Total** | **102** | **30** | **0** | **4** | **68** | **0** |
...
**Wave 5 total points: 208** _(145 prior + 55 REND-fix wave [human-authorized 2026-06-11] + 8 STORY-102 [image binary embedding, rendering-fix wave finalized 2026-06-11 per human "fix ALL findings" directive])_
...
## Wave TBD: Deferred Surfaces / Self-Improvement (1 story)

| Story ID | Epic | Title | BCs | Priority | Points | tdd_mode | Status |
|----------|------|-------|-----|---------|--------|---------|--------|
| [STORY-090](stories/STORY-090-pipeline-integration-test-mandate.md) | EPIC-19 | Mandate pipeline-origin integration tests for multi-crate eval→exporter stories | — | P1 | 3 | strict | draft |

**Wave TBD total points: 3**

_STORY-090 created 2026-06-08 per S-7.02 cycle-closing checklist (PROC-GAP-PIPELINE-BYPASS-TESTS, 3x recurrence in STORY-082/072/081). Codifies the mandate that any story spanning ≥2 crates across the eval→exporter seam MUST include at least one `slideforge::build()`-origin integration test asserting format-native output. Deliver post-Wave-5 gate or as part of Wave-6 preparation._
...
>   - STORY-098: BC-3.03.002 v1.2 authored (Route A: W-VAL-103 content-drop = broken/exit-2 in strict mode; no E-VAL-105); error-taxonomy v2.29
...
> 0 → 1 stories, 0 → 3 pts. Total: 89 → 90 stories, 553 → 556 pts.
>
