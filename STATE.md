...
- 2026-05-27 — STORY-012 MERGED (PR #16, 5eaa81b2) — @for Evaluation + Scoping, slideforge-eval, 124 tests, 6 adversarial passes (8→6→4→0→0→0), 3/3 clean
- 2026-05-27 — STORY-016 MERGED (PR #17, 6022075e) — Canvas Overflow + Zero-Slide + Validation Mode, slideforge-validate, 84 tests, 5 adversarial passes (10→3→0→0→0), 3/3 clean
