...
| **Open PRs** | 0 |
| **Workspace crates** | 16 |
| **Spec deltas this session** | STORY-084 delivered: 7 bundled SectionType impls in slideforge-plugin-api. BC-5.02.001 SectionType surface closed. BC-3.02.001 invariant 4 (notes-exclusion) enforced on both auto types. LESSON-17 added: inverted-Red-Gate anti-pattern. // STORY-085 adversary round 1 (6 findings fixed): F-001 trait extension via ADR-017 Option A (human-approved 2026-06-05) — BC-5.02.001 → v1.4 (Invariant 2 permits additive-defaulted methods); F-002 AC-005 paper-fix test corrected; F-003 12-variant byte-identity; F-004 HTML escaping — BC-3.05.001 → v1.3.6 (HTML escape-all-interpolated + EC-009/EC-010), VP-053 created (proptest, slideforge-plugin-api); F-005 nested-format depth guard; F-006 registry-ready threading anchored to STORY-049; F-008 module-boundary fitness test. BC-5.02.002 → v1.4 (registration-vs-construction split, PC-5/EC-004 clarified). ADR-017 accepted (InlineFormat relationship context + hyperlink ownership). Convergence: 0/3 strict-CLEAN after pass 1 — fixes applied, pass 2 pending. |
