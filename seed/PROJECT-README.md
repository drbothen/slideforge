...
[![CI](https://github.com/yourorg/slideforge/workflows/CI/badge.svg)](https://github.com/yourorg/slideforge/actions)
...
```sh
brew install yourorg/tap/slideforge
```
...
Download from [GitHub Releases](https://github.com/yourorg/slideforge/releases) — macOS (arm64, x86_64), Linux (x86_64), Windows (x86_64).

### From source

```sh
git clone https://github.com/yourorg/slideforge
cd slideforge
