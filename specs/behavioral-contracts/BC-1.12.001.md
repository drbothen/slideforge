...
- `architecture/authoring-subsystem.md#diagram-renderer` — MermaidRenderer + DiagramRenderer trait
- `architecture/authoring-subsystem.md#spike-s14` — mermaid-rs-renderer selection rationale
