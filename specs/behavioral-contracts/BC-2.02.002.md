...
- `architecture/branding-subsystem.md#single-master` — DI-016 single master invariant
- `architecture/pipeline.md#pptx-relationships` — layout-to-master relationship graph
