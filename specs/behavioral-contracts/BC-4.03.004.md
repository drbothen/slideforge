...
- `architecture/export-subsystem.md#web-preview` — axum+WebSocket+SVG preview design
- `architecture/cross-cutting.md#watch-mode` — file watcher + debounce + WebSocket pipeline
