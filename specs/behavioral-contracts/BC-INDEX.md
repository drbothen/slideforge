...
| BC ID | Title | Priority | Status | File |
|-------|-------|----------|--------|------|
| BC-3.05.001 | All 12 inline format types render to correct output per format (plain, bold, italic, code, link, math, footnote, xref, super, sub, strike, highlight) — slide-level fields + unified PPTX engine (ADR-024) | P1 | active | [BC-3.05.001.md](BC-3.05.001.md) | v1.4.1 |
...
| BC-4.01.003 | PPTX Contains Speaker Notes and Master/Layout/Theme System; Slide Sections Deferred to Follow-Up Story | P0 | active | [BC-4.01.003.md](BC-4.01.003.md) | v1.4 (Pass-5 IMP-1: E-PAR-023 exit 2→1; error-taxonomy v2.28; STORY-082 spec_version 1.1; 2026-06-08) |
...
| BC-4.03.003 | Static HTML output passes WCAG AA via axe-core on CI | P0 | active | [BC-4.03.003.md](BC-4.03.003.md) | v1.4 (Pass-4: PC-7 step 4 synthetic-h1 for no-Title/no-promotable-text decks; promotable-text definition; empty-deck exception; EC-006; test vectors) |
